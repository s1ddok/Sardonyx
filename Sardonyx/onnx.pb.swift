...
struct Onnx_AttributeProto {
  ...
  var type: Onnx_AttributeProto.AttributeType = .undefined
  ...
  /// UTF-8 string
  var s: Data = SwiftProtobuf.Internal.emptyData
  ...
  var hasSparseTensor: Bool {return self._sparseTensor != nil}
  /// Clears the value of `sparseTensor`. Subsequent reads from it will return its default value.
  mutating func clearSparseTensor() {self._sparseTensor = nil}
...
struct Onnx_TrainingInfoProto {
  ...
  var hasInitialization: Bool {return self._initialization != nil}
  /// Clears the value of `initialization`. Subsequent reads from it will return its default value.
  mutating func clearInitialization() {self._initialization = nil}
...
struct Onnx_ModelProto {
  ...
  /// emitted the model.
  var producerName: String = String()

  /// The version of the framework or tool used to generate this model.
  /// This field SHOULD be present to indicate which implementation/tool/framework
  /// emitted the model.
  var producerVersion: String = String()
...
struct Onnx_TensorProto {
  ...
  var rawData: Data = SwiftProtobuf.Internal.emptyData
...
struct Onnx_SparseTensorProto {
  ...
  var hasIndices: Bool {return self._indices != nil}
  /// Clears the value of `indices`. Subsequent reads from it will return its default value.
  mutating func clearIndices() {self._indices = nil}
