class RELUMetalConverter: NodeConverter, FusableMetalNeuron {
    ...
    var descriptor: String { "let neuronDescriptor_\(self.node.name) = MPSNNNeuronDescriptor.cnnNeuronDescriptor(with: .reLU, a: 0.0)"}
